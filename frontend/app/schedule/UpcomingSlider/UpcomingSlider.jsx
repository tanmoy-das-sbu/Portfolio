    ...
    return (
        <section className="bg-[#FFFFFF]" >
            ...
            <Carousel className="container relative z-20 noselect m-auto w-4/5 p-2 md:p-10"  >
                <div className=" text-center">
                    <h2 className="headingTag font-bold sm:text-2xl md:text-4xl lg:text-5xl xs:text-xl w-full text-center text-2xl mb-5">Upcoming Events</h2>
                </div>
                <CarouselContent>
                            ...
                            <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
                                <CardContent className="flex aspect-square items-center justify-center p-2">
                                    <Card className="w-[300px] flex flex-col justify-between">
                                        <CardHeader>
                                            <div className=" items-center space-x-1 text-center" style={{ margin: 'auto' }}>
                                            <img src="https://4.bp.blogspot.com/-URiCjwBMxVc/TtzXRyJi90I/AAAAAAAADj8/MrZd0T5ewIg/s1600/bjp-flag.jpg" alt="" />
