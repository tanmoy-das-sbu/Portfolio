      ...
      <div>
        <div>
          {!flag ? (
            ...
            <div>
              <div className="   m-auto pt-4 md:pt-8">
                {flaghead ? (
                  <h2 className="headingTag font-bold text-6xl md:text-4xl w-full text-center mb-5">
                    Today&apos;s Events
                  </h2>
                ) : (
                  <h2 className="font-bold text-5xl md:text-4xl w-full text-center mb-5">
                    ...
                    {todaySchedule?.map((item, index) => (
                      <SwiperSlide className="" key={index}>
                        <div className="w-full flex items-center justify-center pt-8px">
                          <div
                            className="max-w-sm rounded-xl overflow-hidden text-center w-full"
                            style={{
                              boxShadow:
                          ...
                          >
                            <img
                              className="w-full"
                              src="https://tse1.mm.bing.net/th?id=OIP.stuO9HtrREb2xPI9Tlu0LgHaHr&pid=Api&rs=1&c=1&qlt=95&w=119&h=124"
