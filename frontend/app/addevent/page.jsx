...
export default function Addevent() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://portfolio-git-main-tanmoys-projects.vercel.app/schedule/Add",
        {
          method: "POST",
          headers: {
                ...
                <div className="flex flex-col gap-4 ">
                  <div className="flex flex-col gap-4 p-6">
                    ...
                    <div className="flex items-center space-x-2">
                      <Switch id="priority" name="priority" onCheckedChange={()=>{setPriority(!priority)}} />
                      <Label htmlFor="priority">Priority</Label>
                    </div>
                  </div><div className="flex items-center space-x-2">
                      <Label htmlFor="priority">Visibility</Label>
                      <Switch id="priority" name="priority" onCheckedChange={handleOptionChange}/>
                  ...
                  <div className="flex flex-row  justify-around p-4">
                    {option ? (
                      <div>
                        ...
                        <div className="flex items-center space-x-2">
                          <Switch id="visibility" name="visibility" onCheckedChange={()=>{setVisibility(!visibility)}} defaultChecked />
                          <Label htmlFor="visibility">Visibility</Label>
                        </div>
                      </div>
                    ) : (
